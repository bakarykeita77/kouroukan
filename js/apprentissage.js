...
function apprentissages() {
 ...
 /*-----------------------------------------------------------------------------------------------------------------------------------*/
    ...
    function apprentissage() {
        ...
        $('#apprentissage_option_1').click(function(){ preLesson(); fermerApprentissage(); });
        $('#apprentissage_option_2').click(function(){ apprendre(); fermerApprentissage(); });
