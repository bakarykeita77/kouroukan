function alphabet() {
    ...
    .then(matiere_collection => {  
        ...
        let apprentissage_pre_alphabet_effectue = (datas[0][0] == undefined) ? [] : JSON.parse(datas[0][0].lesson);
        let exercice_pre_alphabet_effectue      = (datas[0][1] == undefined) ? [] : JSON.parse(datas[0][1].lesson);
        let evaluation_pre_alphabet_effectue    = (datas[0][2] == undefined) ? [] : JSON.parse(datas[0][2].lesson);

if(datas[0][0] != undefined) console.log("apprentissage effectué = ");
if(datas[0][0] != undefined) console.log(apprentissage_pre_alphabet_effectue);
if(datas[0][1] != undefined) console.log("exercice effectué = ");
if(datas[0][1] != undefined) console.log(exercice_pre_alphabet_effectue);
if(datas[0][2] != undefined) console.log("evaluation effectué = ");
if(datas[0][2] != undefined) console.log(evaluation_pre_alphabet_effectue);

        let matiere = matiereNom(datas[0]);
        let date_d_apprentissage_alphabet_du_serveur = dateDApprentissageAlphabetDuServeur(datas);
        
        let element_actif = "";
        sessionStorage.setItem("matiere",JSON.stringify(matiere));
        let matiere_nom = JSON.parse(sessionStorage.getItem('matiere_nom'));
        let phase_li_id = alphabetPhaseLiId();
        ...
        if(niveau === 1) {
            ...
            function preAlphabetNko() {
                ...
                let lesson_d_apprentissage_pre_alphabet = lessonDAlphabetDuServeur(datas,"alphabet_apprentissage");
                let lesson_d_exercice_pre_alphabet = lessonDAlphabetDuServeur(datas,"alphabet_exercice");
                let lesson_d_evaluation_pre_alphabet = lessonDAlphabetDuServeur(datas,"alphabet_evaluation");
                
                let lettres_apprises = lettresApprises(lesson_d_apprentissage_pre_alphabet);
                let lettres_etudiees = lettresEtudiees(lesson_d_apprentissage_pre_alphabet);
                ...
                function apprentissagePreAlphabet() {
                    ...
                    function chargerApprendrePreAlphabet() {
                        ...
                        function chargerFootDePreAlphabet() {
                            ...
                            $('#pre_apprentissage_btn').html('<p>ߛߓߍߛߎ߲ ߟߊ߬ߓߌ߬ߟߊ߬ߟߌ ߞߍ߫ ߕߎ߲߯</p>');
                            $('#continu_sur_exercice_btn').html('<p>ߛߓߍߛߎ߲ ߡߊ߬ߞߟߏ߬ߟߌ ߞߍ߫</p>');
                    ...
                    function afficherApprendrePreAlphabet() {
                        ...
                        function affichageDApprendrePreAlphabet() {
                            ...
                            afficherApprentissageDialogueBoutons();
                            afficherPreApprendreAlphabetTd();
                            afficherLaNotificationDuDebutDApprentissagePreAlphabet();

                            function afficherApprentissageDialogueBoutons() {
                            ...
                            function afficherLaNotificationDuDebutDApprentissagePreAlphabet() {
                                masquerNotification();
                        ...
                        $('#cercles_des_partis_cadre span').click(function() {
                            ...
                            if(cercle_actif.attr('class') == 'cercle shadow actif') {
                                ...
                                function preparerPreAlphabet() {
                                    ...
                                    notificationDePreApprentissage(); 
                                    ...
                                    function initialiserPreApprentissageData() {
                                        viderLeTableau(pre_apprentissage_alphabet_partiel);
                                        for(let i=0; i<les_lettres_actives.length; i++) pre_apprentissage_alphabet_partiel.push([les_lettres_actives[i], 0, 0]);
                                    }
                                    function notificationDePreApprentissage() {
                                        masquerNotification();
                                        setTimeout(() => {
                                ...
                                function dispenserPreAlphabet() {
                                    ...
                                    console.log((cercle_index+1)*les_lettres_actives.length+" === "+apprentissage_pre_alphabet_effectue.length);
                                    if((cercle_index+1)*les_lettres_actives.length === apprentissage_pre_alphabet_effectue.length) console.log("Cet apprrentissage pre_alphabet partiel est déjà fait");
                                    
                                    console.log("Début d'apprentissage partiel");
                                        ...
                                        td_actif.click(()=>{
                                            if(lesson_d_apprentissage_pre_alphabet.length < 27) {
                                                ...
                                                if(clickable_td.includes(clicked_letter)) {
                                                    ...
                                                    masquerNotificationDApprentissagePreAlphabet();
                                            ...
                                            console.log(pre_apprentissage_alphabet_partiel);
                                            console.log("Fin d'apprentissage partiel");
                
                                                                if(td_actif.css("background-color") == "rgb(85, 85, 85)") {
                                                                    notificationDeFinDApprentissagePreAlphabet();
                                                                    afficherBoutonDExercice();
                                                                    exercicePreAlphabet();

                                                                    function notificationDeFinDApprentissagePreAlphabet() {
                                                                        ecris("apprentissage_notification_corps","\
                                                                        "+felicitation()+" ߣߌ߫ ߟߊ߲ߞߣߍߡߊߣߍ߲ ߠߎ߬ ߓߘߊ߫ ߟߐ߲߫ ߌ ߓߟߏ߫߸ ߢߊ߯ߡߌߟߊ߲ ߞߘߎ ߘߌ߲߯ ߘߎ߭ߡߊ߬ (ߓߌ߬ߢߍ߬ ߓߊ߯ߡߊ ߝߟߍ߫߹) ߞߊ߬ ߘߋ߲߬ߣߍ߲߬ ߞߎߘߊ ߟߎ߬ ߢߊ߯ߡߌ߲߫ ߡߊ߬ߞߟߏ߬ߟߌ ߞߊ߲ߡߊ߬. <br>ߣߵߊ߬ߟߎ߫ ߘߏ߲߬ ߡߊ߫ ߓߊ߲߫ ߟߐ߲߫ ߠߴߌ ߓߟߏ߫߸ ߒ߬ߓ،ߊ߬ߟߎ߫ ߘߋ߰ߟߌ ߥߴߊ߬ ߡߊ߬߸ ߤߊ߲߯ ߊ߬ߟߎ߬ ߦߋ߫ ߕߏ߫ ߌ ߞߣߐ߫.\
                                                                        "); 
                                                                    }
                                                                }
                                                            }
                                                    ...
                                                    function masquerNotificationDApprentissagePreAlphabet() {
                                                        if(clicked_td.css("background-color") == "rgb(85, 85, 85)") if(clicked_td_length === 0) { { 
                        ...
                        function rappelDuCercleActif() {
                            ...
                            if(lesson_d_apprentissage_pre_alphabet.length < 27) {
                                $('.pre_apprentissage_tr:not(.actif), .cercle:not(.actif)').click(function() {
                                    if(pre_apprentissage_alphabet_partiel.length === 0) secouer($('.cercle:nth-child('+alphabet_tr_index+')')); 
                                });
                            }
                        }
                    }
                ...
                function exercicePreAlphabet() {
                    $('#exercice_btn, #reprendre_exercice_btn, #continu_sur_exercice_btn').click(function(e) {
                        ...
                        if((cercle_index+1)*les_lettres_actives.length === exercice_pre_alphabet_effectue.length) {
                            console.log("L'exercice pre_alphabet est déjà fait");
                        }
                        
                        console.log("Début d'exercice partiel");
                        ...
                        function chargerExercicePreAlphabet() {
                            ...
                            function chargerPiedDExercicePreAlphabet() {
                                ...
                                $('#revision_btn').html('<p>ߛߓߍߛߎ߲ ߞߘߐߓߐߟߌ ߞߍ߫</p>');
                            }
                        ...
                        function afficherExercicePreAlphabet() {
                            afficherExercice();
                            afficherNotificationDuDebutDExercicePreAlphabet();

                            function afficherNotificationDuDebutDExercicePreAlphabet() {
                                masquerNotification();
                                setTimeout(() => {
                        ...
                        function exercerAlphabet() {
                            ...
                            function initialiserExercicePreAlphabetPartiel() {
                                ...
                                for(let i=0; i<pre_questions.length; i++) pre_exercice_alphabet_partiel.push([pre_questions[i], 0, 0]); 
                            }                                                                                                                                 
                                ...
                                $('#exercice_question_btn').click(function() { 
                                    ...
                                    if(i < total_exercice_questions) { 
                                        ...
                                        function actualiserLeLabelDeQuestionBtn() {
                                            ...
                                            $('#exercice_question_btn').html('<p>ߢߌ߬ߣߌ߲߬ߞߊ߬ߟߌ '+parseIntNko(total_exercice_questions)+' \\ '+ordre_de_question+'߲ ߠߊߡߍ߲߫</p>');
                                        }
                                        function actualiserLeLabelDeRepetitionBtn() {
                                            ...
                                            $('#exercice_repetition_btn').html("<p>"+repeter_btn_html+"</p>");
                                        }
                                    }
                                });
                            }
                            ...
                            function repondreExercicePreQuestion() {
                                $.each($('#exercice_body td'), function() {
                                    ...
                                    td.click(function(){
                                        if(pre_question == "") { secouer($("#exercice_question_btn")); }
                                        if(pre_question != "") {
                                    ...
                                    if(total_questions_posees <= total_exercice_questions) { 
                                        ...
                                        function finDExercicePreAlphabet() {
                                            ...
                                            /* Suppression d'effet des clicks précédents sur les dialogue_btns */
                                                ...
                                                console.log("Fin de pre_exercice partiel");
                                                ...
                                                function fermerPreExercice() {
                                                    $('#apprentissage .fermeture_pre').one('click',function(){    
                                                        ...
                                                        setTimeout(() => {
                                                            if(note_d_exercice_pre_alphabet < 100) { $('#exercice_btn').html('<p>ߡߊ߬ߞߟߏ߬ߟߌ ߞߍ߫ ߕߎ߲߯</p>'); }
                ...
                function evaluationPreAlphabet() {
                    $('#revision_btn, #reprendre_revision_btn, #continu_sur_revision_btn').click(function(e) {
                        ...
                        if((cercle_index+1)*les_lettres_actives.length === evaluation_pre_alphabet_effectue.length) console.log("L'evaluation pre_alphabet est déjà fait");
                        
                        console.log("Début d'évaluation partiel");
                        ...
                        function chargerEvaluationPreAlphabet() {
                            ...
                            function chargerPiedDePreRevisionAlphabet() {
                                ...
                                $('#reprendre_revision_btn').html(matiere_nom+' ߣߐ߰ߡߊ߬ߛߍߦߌ ߞߍ߫ ߕߎ߲߯');
                        ...
                        function afficherEvaluationPreAlphabet() {
                            ...
                            afficherRevision();
                            masquerNotification();
                            setTimeout(() => { ecris('revision_notification_corps',notification); }, 1500);
                        }
                        function  evaluerPreAlphabet() {
                            ...
                            function initialiserEvaluationPreAlphabetPartiel() {
                                ...
                                for(let i=0; i<evaluation_pre_questions.length; i++) pre_evaluation_alphabet_partiel.push([evaluation_pre_questions[i], 0, 0]); 
                            }
                            ...
                            function repondreEvaluationPreQuestion() {
                                $.each($('#revision_body td'), function() {
                                    let td = $(this);
                                    td.click(function(){
                                        // if(pre_question == "") { secouer($("#revision_question_btn")); }
                                        if(pre_question == "") { 
                                ...
                                $('#revision_correction_btn').click(function(e) { 
                                                    ...
                                                    $('#apprentissage .fermeture_pre').one('click',function(){    
                                                        ...
                                                        setTimeout(() => {
                                                            ...
                                                            if(note_d_evaluation_pre_alphabet < 100) {
                                                                ...
                                                                $('#revision_btn').html('<p>ߣߐ߰ߡߊ߬ߛߍߦߌ ߞߍ߫ ߕߎ߲߯</p>');
                                                            }
                                                            if(note_d_evaluation_pre_alphabet == 100) {
                                                ...
                                                function stockerEvaluationPreAlphabet() {
                                                 /* Pourque l'évaluation soit stockée, il faut que la note d'évaluation soit superieur ou égale à la moyenne */
                                                    ...
                                                    if(note_d_evaluation_pre_alphabet >= 92) {
                                                        ...
                                                        lesson_d_evaluation_pre_alphabet = actualiserLesson(lesson_d_evaluation_pre_alphabet,pre_evaluation_alphabet_partiel);
                    
                                                        console.log(pre_evaluation_alphabet_partiel);
                                    console.log("Fin de pre_evaluation partiel");
                                    ...
                                    console.log(lesson_d_evaluation_pre_alphabet);
                                                        ...
                                                        if(lesson_d_apprentissage_pre_alphabet.length < 27) {
                                                            ...
                                                            lettres_apprises = lettresApprises(lesson_d_apprentissage_pre_alphabet);
                                                            stockerPreAlphabet();
                                                            
                                                            function stockerPreAlphabet() { 
                                                                ...
                                                                if((cercle_index+1)*total_yellow_letter > lesson_d_apprentissage_pre_alphabet.length) {
                                                                    ...
                                                                    /* Recupreation des id de alphabet_apprentissage et alphabet_exercice précédents pour leurs modifications ulterieures */
                                                                    let id_alphabet_apprentissage = null;
                                                                    let id_alphabet_exercice = null;

                                                                    if(datas[0].length != 0) {
                                                                        for(let i=0; i<2; i++) {
                                                                            if(datas[0][i] != undefined) {
                                                                                if(datas[0][i].phase == "alphabet_apprentissage") { id_alphabet_apprentissage = datas[0][i].id; }
                                                                                if(datas[0][i].phase == "alphabet_exercice") { id_alphabet_exercice = datas[0][i].id; }
                                                                            }
                                                                        }
                                                                    }
                                                                    /* Fin de recuperationdes id */
                                                                    
                                                                    stockageDApprentissagePreAlphabet();
                                                                    stockageDExercicePreAlphabet();
                                                                    notificationDuSuccesDeRevision();
                                                                    afficherRedirectionBtns();
                                                                            

                                                                    function stockageDApprentissagePreAlphabet() {
                                                                        let note_d_apprentissage_alphabet_partiel = calculerNote(pre_apprentissage_alphabet_partiel);

                                                                        if (note_d_apprentissage_alphabet_partiel === 100) {
                                                                            
                                                                            let lesson_d_apprentissage_alphabet_du_serveur = lessonDAlphabetDuServeur(datas,"alphabet_apprentissage");
                                                                            lesson_d_apprentissage_pre_alphabet = actualiserLesson(lesson_d_apprentissage_alphabet_du_serveur, pre_apprentissage_alphabet_partiel);
                                                         
                                                                            if(datas[0].length == 0) {
                                                                                sendLessonDataToDB("alphabet_apprentissage", lesson_d_apprentissage_pre_alphabet);
                                                                                console.log("Lesson d'apprentissage alphabet est envoyée à la base de donnée.");
                                                                            }
                                                                            if(datas[0].length != 0) {
                                                                                for (let i = 0; i < datas[0].length; i++) {
                                                                                    if(datas[0][i] != undefined) if(datas[0][i].phase == "alphabet_apprentissage") {
                                                                                        updateLessonData(id_alphabet_apprentissage,lesson_d_apprentissage_pre_alphabet);
                                                                                        console.log("Lesson d'apprentissage alphabet est modifiée à la base de donnée.");
                                                                                    }
                                                                                }
                                                                            }
                                                                        }
                                                                    }
                                                                    function stockageDExercicePreAlphabet() {

                                                                        let note_d_exercice_alphabet = calculerNote(pre_exercice_alphabet_partiel);

                                                                        if (note_d_exercice_alphabet === 100) {

                                                                            let lesson_d_exercice_alphabet_du_serveur = lessonDAlphabetDuServeur(datas,"alphabet_exercice");
                                                                            lesson_d_exercice_pre_alphabet = actualiserLesson(lesson_d_exercice_alphabet_du_serveur, pre_exercice_alphabet_partiel);
                                                                            ...
                                                                            if(datas[0].length != 0) {
                                                                                for (let i = 0; i < datas[0].length; i++) {
                                                                                    if(datas[0][i] != undefined) if(datas[0][i].phase == "alphabet_exercice") {
                                                                                        updateLessonData(id_alphabet_exercice,lesson_d_exercice_pre_alphabet);
                                                                    ...
                                                                    function notificationDuSuccesDeRevision() {
                                                                        ecris("revision_notification_corps","\
                                                                            "+felicitation() + $("#revision_notification_titre").text() + " ߢߊ߬ߣߍ߲߬ "+note_d_evaluation_pre_alphabet+"% ߟߊ߫. ߌ ߓߘߊ߫ ߛߎߘߊ߲߫ ߞߊ߬ ߛߓߍߛߎ߲ ߟߊ߬ߓߌ߬ߟߊ߬ߟߌ ߥߴߊ߬ ߡߊ߬.\
                                                                        ");
                                                                    }
                                                                    function afficherRedirectionBtns() {
                                                                        setTimeout(() => {
                                                                            ...
                                                                            continuSurApprentissageAlphabet();
                                                                            ...
                                                                            function continuSurApprentissageAlphabet() {
                                                        ...
                                                        if(lesson_d_apprentissage_pre_alphabet.length === 27) {
                                                            ...
                                                            if(pourcentagePoint(lesson_d_evaluation_pre_alphabet) >= 92) {
                                                                ...
                                                                stockageDEvaluationPreAlphabet();
                                                            ...
                                                            function stockageDEvaluationPreAlphabet() {
                                                ...
                                                function resultatGeneralDAlphabet() {
                                                    ...
                                                    if(datas[0].lesson != undefined) {
                                                    if(datas[1].lesson != undefined) {
                                                    if(datas[2].lesson != undefined) {

                                                        let point_d_apprentissage = calculerPoint(datas[0].lesson);
                                                        let point_d_exercice = calculerPoint(datas[1].lesson);
                                                        let point_d_evaluation = calculerPoint(datas[2].lesson);

                                                        note_d_apprentissage_pre_alphabet = pourcentagePoint(lesson_d_apprentissage_pre_alphabet);
                                                        note_d_evaluation_pre_alphabet = pourcentagePoint(lesson_d_evaluation_pre_alphabet);
                                                        
                                                        if(note_d_apprentissage_pre_alphabet === 100) {
                                                        if(note_d_exercice_pre_alphabet === 100) {
                                                        if(note_d_evaluation_pre_alphabet >= 92) {
                                                                    ...
                                                                    <div id="resultat_table_container">\
                                                                        <table id="resultat_table">\
                                                                            ...
                                                                            <tr>\
                                                                                ...
                                                                                <td>'+parseIntNko(datas[0].lesson.length)+'</td>\
                                                                                <td>'+parseIntNko(point_d_apprentissage)+'</td>\
                                                                                <td>'+parseIntNko(note_d_apprentissage_pre_alphabet)+'</td>\
                                                                            </tr>\
                                                                            <tr>\
                                                                                <td>ߛߓߍߛߎ߲ ߡߊ߬ߞߟߏ߬ߟߌ</td>\
                                                                                <td>'+parseIntNko(datas[1].lesson.length)+'</td>\
                                                                                <td>'+parseIntNko(point_d_exercice)+'</td>\
                                                                                <td>'+parseIntNko(note_d_exercice_pre_alphabet)+'</td>\
                                                                            </tr>\
                                                                            <tr>\
                                                                                <td>ߛߓߍߛߎ߲ ߞߘߐߓߐߟߌ</td>\
                                                                                <td>'+parseIntNko(datas[2].lesson.length)+'</td>\
                                                            ...
                                                            $('#afficheur_de_resultat').click(function() { resultatDeLaMatiere(datas[0]); });
                                                        }}}
                                                    }}}
                                                }
                                            }
            ...
            function alphabetNko() {
                ...
                function apprentissageAlphabet() {
                    $('#alphabet_apprentissage').click(() => { 
                        ...
                        lesson_d_apprentissage_alphabet_du_serveur = lessonDApprentissagePreAlphabetDuServeur(datas);
                        ...
                        if(lesson_d_apprentissage_alphabet_du_serveur.length != 0) console.log("La leçon d'apprentissage alphabet est déjà faite.");
                        ...
                        function chargerApprentissageAlphabet() {
                            ...
                            function chargerEnteteDeApprentissageAlphabet() {
                                ...
                                setTimeout(() => {
                                    ...
                                    if(note_d_apprentissage_alphabet != 0) {
                                        if(datas.length === 0) {
                                        if(data_alphabet_apprentissage != null) {
                                            ecris('apprentissage_notification_corps','\
                                                ߛߓߍߛߎ߲ ߟߊ߬ߓߌ߬ߟߊ߬ߟߌ ߘߋ߲߰ߣߍ߲߬ ߞߘߐ ߟߴߌ ߓߟߏ߫ ߞߊ߬ߓߌ߫ '+dateEnNko(data_alphabet_apprentissage.date)+'߸ ߏ߬ߘߐ߬ ߌ ߘߌ߫ ߛߴߊ߬ ߡߊߛߍ߬ߦߌ߬ ߟߊ߫߸ ߞߐ߬ߣߌ߲߬ ߊ߬ ߕߍ߫ ߖߊ߰ߕߋ߬ ߟߊ߫.<br>\
                                            ');
                                        }}
                                        if(datas.length != 0) {
                                        if(data_alphabet_apprentissage == null) {
                                        ...
                                        *cet élément et le point new_mark. Ce tableau est régulièrement actualisé à chaque click */ 
                                        ...
                                        function finDApprentissageAlphabet() {
                                            if(stocker_apprentissage_status == 'non_stocker') {
                                                ...
                                                if(clicked_elements_quantity >= lesson_d_apprentissage_alphabet.length) $('#apprentissage_dialogue_btns').css("background-color","yellow");
                                                    ...
                                                    if(lettres_cliques.length === 27) {
                                                        if(stocker_apprentissage_status == "non_stocker") {
                                                            ...
                                                            function stockerApprentissageAlphabet() {
                                                                ...
                                                                let niveau_d_apprentissage = niveau;
                                                                ...
                                                                if(note_d_apprentissage_alphabet >= moyenne_d_apprentissage) {
                                                                    ...
                                                                    data_alphabet_apprentissage = {"date":date_d_apprentissage, "niveau":niveau_d_apprentissage, "phase":phase_d_apprentissage, "lesson":lesson_d_apprentissage_alphabet, "note":note_d_apprentissage_alphabet};
                                                            ...
                                                            function transitionVersExerciceAlphabet() {
                                                                ...
                                                                if(note_d_apprentissage_alphabet == 100) {
                                                                    ...
                                                                    $('#continu_sur_exercice_btn').click(() => { raffraichirLaPage(); });
                                                                }
                                                            }
                                                        }else{
                                                            alert("ߛߓߍߘߋ߲ ߠߎ߬ ߘߋ߰ߣߍ߲߬ ߞߘߐ ߟߋ߬.");
                                                        }
                                                    }else{
                ...
                function exerciceAlphabet() {
                    $('#alphabet_exercice, #continu_sur_exercice_btn').click(() => {

                        console.log("Début d'Exercice d'alphabet");

                        let phase_id = "alphabet_exercice";
                        sessionStorage.setItem("phase_id", JSON.stringify(phase_id));
                        let date_d_exercice_alphabet_du_serveur = '', niveau_d_exercice_alphabet_du_serveur = 1, phase_d_exercice_alphabet_du_serveur = phase_li_id, lesson_d_alphabet_exercice_du_serveur = [], note_d_exercice_alphabet_du_serveur = 0;
                        
                        lesson_d_alphabet_exercice_du_serveur = lessonDExercicePreAlphabet(datas);
                        ...
                        if(datas[0].length != 0) {
                            ...
                            lesson_d_alphabet_exercice_du_serveur = (datas[0][1] == undefined) ? [] : JSON.parse(datas[0][1].lesson);
                            note_d_exercice_alphabet_du_serveur = (datas[0][1] == undefined) ? 0 : datas[0][1].note;

                            exercice_alphabet_stocker_au_serveur = {"date":date_d_exercice_alphabet_du_serveur, "niveau":niveau_d_exercice_alphabet_du_serveur, "phase":phase_d_exercice_alphabet_du_serveur, "lesson":lesson_d_alphabet_exercice_du_serveur, "note":note_d_exercice_alphabet_du_serveur}
                        }

                        if(lesson_d_alphabet_exercice_du_serveur.length != 0) {
                            console.log("La leçon d'exercice alphabet est déjà faite.");
                            return;
                        }

                        let lesson_d_alphabet_exercice = JSON.parse(sessionStorage.getItem('lesson_d_alphabet_exercice'));
                        lesson_d_alphabet_exercice = (lesson_d_alphabet_exercice == null) ? [] : lesson_d_alphabet_exercice;
                        lesson_d_alphabet_exercice = (lesson_d_alphabet_exercice_du_serveur.length == 0) ? lesson_d_alphabet_exercice : lesson_d_alphabet_exercice_du_serveur;

                        let data_alphabet_exercice = JSON.parse(sessionStorage.getItem('data_alphabet_exercice'));

                        if(lesson_d_alphabet_exercice.length != 0) { 
                            console.log("La leçon d'exercice alphabet n'est pas vide, ce qui veut dire que cette leçon est déjà faite. Voir ci-dessous");
                            console.log(lesson_d_alphabet_exercice);
                        ...
                        if(lesson_d_alphabet_exercice.length === 0) {
                            ...
                            function chargerExerciceAlphabet() {
                                ...
                                function chargerPiedDeExerciceAlphabet() {
                                    $('#exercice_question_btn').html('<p>ߢߌ߬ߣߌ߲߬ߞߊ߬ߟߌ '+parseIntNko(exercice_questions.length)+' \\ ߁߭ ߟߊߡߍ߲߫</p>');
                            ...
                            function exercerAlphabetNko() {
                                ...
                                poserAlphabetExerciceQuestion();
                                repeterAlphabetExerciceQuestion();
                                repondreAlphabetExerciceQuestion();
                                corrigerAlphabetExerciceQuestion();

                                
                                function initialiserExerciceAlphabet() {
                                    for(var i=0;i<exercice_questions.length;i++) {
                                        var q = exercice_questions[i], r = '', p = 0;
                                        lesson_d_alphabet_exercice[i] = [q,r,p];
                                    }
                                    data_alphabet_exercice = {"date":date_d_exercice, "niveau":niveau_d_exercice, "phase":phase_d_exercice, "lesson":lesson_d_alphabet_exercice, "note":note_d_exercice_alphabet};
                                }
                                ...
                                function poserAlphabetExerciceQuestion(){
                                    $('#exercice_question_btn').on('click',function() {
                                        ...
                                        function actualiserExerciceQuestionBtn(){ 
                                            ...
                                            $('#exercice_question_btn').html('<p>ߢߌ߬ߣߌ߲߬ߞߊ߬ߟߌ '+parseIntNko(exercice_questions.length)+' \\ '+parseIntNko(compteur_d_exercice_question + 1)+'߲ ߠߊߡߍ߲߫</p>');
                                            $('#exercice_repetition_btn').html(repeter_btn_html);
                                        }
                                    });
                                }
                                function repeterAlphabetExerciceQuestion(){ 
                                ...
                                function repondreAlphabetExerciceQuestion(){
                                ...
                                function corrigerAlphabetExerciceQuestion() {
                                    ...
                                    $('#exercice_correction_btn').click(function() {
                                        if(exercice_question != '') {
                                            ...
                                            function enregistrerExerciceAlphabet() { 
                                                ...
                                                lesson_d_alphabet_exercice.splice(exercice_counter,1,question_reponse);
                                                exercice_counter++;
                                            }
                                            ...
                                            function finDExerciceAlphabet() {  
                                                if(compteur_d_exercice_question - 1 == exercice_questions.length) {
                                                    setTimeout(() => {
                                                        ...
                                                        note_d_exercice_alphabet = calculerNote(lesson_d_alphabet_exercice);
                                
                                                        masquerNotification();
                                                        notificationDeFinDExerciceAlphabet();
                                                        redirectionDExercicePreAlphabet(lesson_d_alphabet_exercice);
                                                        reprendreExerciceAlphabet();
                                                        stockerExerciceAlphabet();
                                                        resultatDeLaMatiere(datas[0]);
                                                        transitionVersEvaluationAlphabet();
                                    
                                                        function reprendreExerciceAlphabet() {
                                                            if(note_d_exercice_alphabet < moyenne_d_exercice) { 
                                                                $('#reprendre_exercice_btn').click(function(e) {
                                                                    e.stopImmediatePropagation();
                                                                    
                                                                    viderLeTableau(lesson_d_alphabet_exercice);
                                                                    if(option_retenue == 2) {
                                                        ...
                                                        function stockerExerciceAlphabet() {  
                                                            if(note_d_exercice_alphabet <  moyenne_d_exercice) alert( "ߌ ߟߊ߫ ߓߍ߬ߙߍ߫ ߛߐ߬ߘߐ߲߬ߣߍ߲ ߡߎ߬ߡߍ ߦߋ߫ "+parseIntNko(note_d_exercice_alphabet)+" ߟߋ߬ ߘߌ߫\n ߊ߬ ߡߊ߫ "+parseIntNko(moyenne_d_exercice)+" ߖߘߍ߬ ߓߐ߫ \n\n ߏ߬ߘߐ߬ ߛߍ߬ߦߌ߬ ߦߙߐ ߢߌ߲߬ ߡߊ߫." ); 
                                                            if(note_d_exercice_alphabet >= moyenne_d_exercice) { 

                                                                sendLessonDataToDB('alphabet_exercice', lesson_d_alphabet_exercice); 
                                                                data_alphabet_exercice = {"date":date_d_exercice, "niveau":niveau_d_exercice, "phase":phase_d_exercice, "lesson":lesson_d_alphabet_exercice, "note":note_d_exercice_alphabet};

                                                                sessionStorage.setItem('lesson_d_alphabet_exercice', JSON.stringify(lesson_d_alphabet_exercice));
                                                                sessionStorage.setItem('data_alphabet_exercice', JSON.stringify(data_alphabet_exercice));
                                                        ...
                                                        function transitionVersEvaluationAlphabet() {
                                                            if(note_d_exercice_alphabet >= moyenne_d_exercice) { 
                                                                $('#continu_sur_revision_btn').click(() => { raffraichirLaPage(); });
                                                            }
                                                        }
                                                    }, 600);
                                                }
                ...
                function evaluationAlphabet() {
                    $('#alphabet_evaluation, #continu_sur_evaluation_btn').click(() => {
                        ...
                        lesson_d_evaluation_alphabet_du_serveur = lessonDEvaluationPreAlphabet(datas);
                        ...
                        data_alphabet_evaluation = JSON.parse(sessionStorage.getItem('data_alphabet_evaluation'));
                        ...
                        if(lesson_d_evaluation_alphabet_du_serveur.length != 0) { 
                            ...
                            console.log(lesson_d_evaluation_alphabet);
                            apprentissageAlphabet(); 
                            fermerLaPage(); 
                        }
                        ...
                        if(lesson_d_evaluation_alphabet_du_serveur.length === 0) {
                            ...
                            function chargerEvaluationAlphabet() {
                                ...
                                function chargerPiedDeEvaluatonAlphabet() {
                                    $('#evaluation_question_btn').html("<p>ߢߌ߬ߣߌ߲߬ߞߊ߬ߟߌ߫ "+q_total+" \\ ߁߭ ߟߊߡߍ߲߫</p>");
                                }
                                function chargerCorpsDeEvaluatonAlphabet() {
                                    chargementParDefautDEvaluationFicheBody();
                                }
                            }
                            function evaluerAlphabet() {
                                ...
                                var note_d_evaluation_alphabet = 0;
                                ...
                                function initialiserEvaluationAlphabet() {
                                    for(var i=0;i<evaluation_questions.length;i++) {
                                        ...
                                        lesson_d_evaluation_alphabet_du_serveur[i] = [q,r,p];
                                    }
                                    data_alphabet_evaluation = {"date":date_d_evaluation, "niveau":niveau, "phase":phase_d_evaluation, "lesson":lesson_d_evaluation_alphabet_du_serveur, "note":note_d_evaluation_alphabet};
                                }
                    ...
                    console.log(question_evaluation); 
                                        ...
                                        function actualiserLesLibellesDeDialogueBtn(){
                                            ...
                                            $("#evaluation_question_btn").html("<p>ߢߌ߬ߣߌ߲߬ߞߊ߬ߟߌ߫ "+q_total+" \\ "+q_ordre+q_rang+" ߟߊߡߍ߲߫</p>");
                                            $("#evaluation_repetition_btn").html("<p>ߢߌ߬ߣߌ߲߬ߞߊ߬ߟߌ "+parseIntNko(q_index)+q_rang+" "+action+"</p>");
                                        }
                    ...
                    console.log(question_evaluation); 
                                        ...
                                        function reAfficherEvaluationRepetitionBtn() { afficherBoutonDeRepetition(); }
                                    });
                                }
                                    ...
                                    $('#clavier_nko td').on('click', function(){
                                        ...
                                        if(question_evaluation != '') {
                                            ...
                                            function afficherEvaluationCorrectionButton(){
                                                ...
                                                setTimeout(() => { 
                                                    afficher($("#evaluation_correction_btn")); 
                                                    rendreActif($("#evaluation_correction_btn")); 
                                                }, 100);
                                            }
                                        }
                                    });
                                ...
                                function correctionDEvaluationAlphabet() {
                                    ...
                                    $('.correction_btn').on('click', function(){
                                        ...
                                        function corrigerEvaluation(){
                                            ...
                                            function enregistrerExerciceAlphabet() { 
                                                lesson_d_evaluation_alphabet_du_serveur.splice(evaluation_counter,1,question_reponse); 
                                            }
                                            function chargerInstantannementEvaluationTbody() {
                                                ...
                                                $('#total_point_d_evaluation').html(parseIntNko(note_d_evaluation_alphabet));
                                                $('#pourcentage_point_d_evaluation').html('%'+parseIntNko(note_d_evaluation_alphabet*100/nbr_max_de_questions_a_poser));
                                            }                                    
                                        ...
                                        function finDeEvaluationAlphabet() {
                                            if(q_index==nbr_max_de_questions_a_poser) {
                                                ...
                                                if(note_d_evaluation_alphabet >= moyenne_d_evaluation) {
                                                    setTimeout(() => {
                                                        ecris('evaluation_notification_corps','\
                                                ...
                                                function stockerEvaluationAlphabet() {
                                                    ...
                                                    sendLessonDataToDB('alphabet_evaluation',lesson_d_evaluation_alphabet_du_serveur);
                                                    changerPhaseActive(index_phase_active);
                                                    
                                                    if(index_phase_active+1 === total_phase) sessionStorage.setItem('niveau',JSON.stringify(niveau+1));
            ...
            function lettresApprises(lesson) {
                if(lesson.length != 0) {
                    let la = [];
            ...
            function redirectionDExercicePreAlphabet(data) {
                ...
                setTimeout(() => {
                    ...
                    if(note < 100) {
                        afficherRapidement($('#reprendre_exercice_btn'));
                        $('#reprendre_exercice_btn').html('<p>'+liste_de_matieres[0][1]+' ߡߊ߬ߞߟߏ߬ߟߌ ߞߍ߫ ߕߎ߲߯</p>');
                        rendreActif($('#reprendre_exercice_btn'));
                        indexer($('#reprendre_exercice_btn p'));
                    }
                    if(note === 100) {
                        afficherRapidement($('#continu_sur_revision_btn'));
                        $('#continu_sur_revision_btn').html('<p>'+liste_de_matieres[0][1]+' ߞߘߐߓߐߟߌ ߞߍ߫</p>');
                        rendreActif($('#continu_sur_revision_btn'));
                        indexer($('#continu_sur_revision_btn p'));
                    }
                }, 1500);
            }
            function redirectionDEvaluationPreAlphabet(data) {
                ...
                setTimeout(() => {
                    ...
                    if(note < 92) {
                        ...
                        masquer($('#revision_redirection_btns > div'));
                        afficherRapidement($('#reprendre_revision_btn'));
                        
                        $('#reprendre_revision_btn').html('<p>'+liste_de_matieres[0][1]+' ߣߐ߰ߡߊ߬ߛߍߦߌ ߞߍ߫ ߕߎ߲߯</p>');
                        rendreActif($('#reprendre_revision_btn'));
                        indexer($('#reprendre_revision_btn p'));
                    }

                    if(note >= 92) {
                        if(data.length < 27) {
                            masquer($('#revision_redirection_btns > div'));
                            afficherRapidement($('#continu_sur_apprentissage_btn'));

                            $('#continu_sur_apprentissage_btn').html('<p>'+'ߥߊ߫ '+liste_de_matieres[0][1]+' ߟߊ߬ߓߌ߬ߟߊ߬ߟߌ ߡߊ߬</p>');
                            rendreActif($('#continu_sur_apprentissage_btn'));
                            indexer($('#continu_sur_apprentissage_btn p'));
        ...
        function lessonDAlphabetDuServeur(datas,phase) {
            ...
            if (datas[0].length != 0) {
                for (let i = 0; i < datas[0].length; i++) {
                    if(datas[0][i] != undefined) if(datas[0][i].phase == phase) lesson_d_alphabet_du_serveur = JSON.parse(datas[0][i].lesson);
                }
            }
            return lesson_d_alphabet_du_serveur;
        }
        function alphabetPhaseLiId() {
            let phase_li_id = "";
            let phases_etudiees = phasesEtudieesDuServeur(datas);
            let toutes_les_phases = ["alphabet_apprentissage", "alphabet_exercice", "alphabet_evaluation"];

            if(phases_etudiees.length == 0) phase_li_id = toutes_les_phases[0];
            if(phases_etudiees.length == 1) phase_li_id = toutes_les_phases[1];
            if(phases_etudiees.length == 2) phase_li_id = toutes_les_phases[2];
