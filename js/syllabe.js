                                        ...
                                        */
                                        $.each($('.check_btn'), function () {
                                            ...
                                            if (clicked_consonne == consonne_corespondante.text()) {
                                                if(panneau_consonne_index == "-1") {consonne_corespondante.click();}
                                                if(panneau_consonne_index != "-1") {setTimeout(() => { consonne_corespondante.click(); stylesDesSyllabes(); }, 700); }
                                            }
                                        });
                                    }
                                }
                                                    ...
                                                    if (note_d_exercice_pre_syllabe < 100) {
                                                        ...
                                                        function affichageDeRepriseDExerciceBtn() {
                                                            ...
                                                            setTimeout(() => {
                                                                ...
                                                                indexer($('#reprendre_exercice_bouton p'));   //L'évenement click est attaché à ce bouton dès le début de la fonction  exercicePreSyllabe().
                                                    ...
                                                    if (note_d_exercice_pre_syllabe == 100) {
                                                        ...
                                                        function affichageDeRevisionRedirectionBtn() {
                                                            ...
                                                            setTimeout(() => {
                                                                ...
                                                                indexer($('#continu_sur_revision_bouton p'));   //L'évenement click est attaché à ce bouton dès le début de la fonction  exercicePreSyllabe().
                                                            }, 1800);
                                                        }
                                                    }
