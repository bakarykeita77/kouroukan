    ...
    if (niveau_actif === 2) {
             ...
             /* Recupreation des id de syllabe_apprentissage et syllabe_exercice précédents pour leurs modifications ulterieures */
                ...
                function exercicePreSyllabe() {
                    $('#exercice_bouton, #reprendre_exercice_bouton, #continu_sur_exercice_bouton').click(function (e) {
                        ...
                        memoriserEnSessionStorage(lesson_active);
                                                            ...
                                                            if (lesson_d_exercice_pre_syllabe.length === 14) {
                                                                if (lesson_de_revision_pre_syllabe.length === 14) {
                                                                    if (lesson_d_evaluation_pre_syllabe.length === 14) {
                                                                        ...
                                                                        memoriserEnSessionStorage(matiere_nom);
                                                                        niveaux_etudies.push(niveau_en_cours);
                                                                        memoriserEnSessionStorage(niveaux_etudies);
        ...
        function syllabeNko() {
            $('#phases_list li').on('click', function () {
                ...
                memoriserEnSessionStorage(phase_class);
                memoriserEnSessionStorage(phase_li_id);
                memoriserEnSessionStorage(phase_nom);
                memoriserEnSessionStorage(course_id);
                                        ...
                                        if (clicked_elements_quantity === 3) {
                                            ...
                                            function stockerApprentissageSyllabe() {
                                                ...
                                                if (note >= moyenne_d_apprentissage) {
                                                    ...
                                                    memoriserEnSessionStorage(lesson_d_apprentissage_syllabe_du_serveur);
